namespace vz.Extensions
{
    ...
    {  /// <summary>
       /// Extends DateTime with a method to safely append a timestamp to a filename for Windows file systems.
       /// If no filename is provided, it returns a safe timestamp string that can be used as a filename.
       /// </summary>
       /// <param name="dateTime">The DateTime to convert.</param>
       /// <param name="fileName">The optional filename to which the timestamp will be appended. If empty, only the timestamp is returned.</param>
       ...
       /// <exception cref="ArgumentNullException">Thrown when the filename provided is only whitespace.</exception>
        ...
        public static DateTime FirstDayOfWeek(this DateTime? date)
        {
            ...
            // Subtract the number of days from Monday (0) to the given day. 
            // This will move the date back to the start of the week (Monday).
